...
/***/ function(module, exports, __webpack_require__) {
	...
	var Radio = __webpack_require__(10);
	Backbone.Radio = Radio;

	Backbone.Marionette = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WindowResizer = function WindowResizer() {
	  var $window = $(window);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Marionette = __webpack_require__(1).Marionette;
	...
	module.exports = function (app) {
	  app.addInitializer(function () {
	    new Router({
	      controller: __webpack_require__(5)(app)
	    });
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (app) {
	  app.addInitializer(function () {
	    new Router({
	      controller: __webpack_require__(6)(app)
	    });
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(9);
	var Marionette = __webpack_require__(1).Marionette;
	var InfoModel = __webpack_require__(12);
	var ControlsView = __webpack_require__(13);
	...
	var Controller = Marionette.Controller.extend({
	  ...
	  join: function join(roomName) {
	    var model = new InfoModel({
	      roomName: roomName
	    });

	    model.connect().done(_.bind(function () {
	      this.app.mainRegion.show(new ControlsView({ model: model }));
	    }, this));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = Marionette.Controller.extend({
	  ...
	  display: function display(roomName) {
	    var model = new Model({
	      roomName: roomName
	    });

	    model.connect().done(_.bind(function () {
	      this.app.mainRegion.show(new View({ model: model }));
	    }, this));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;// Backbone.Radio v0.9.0
	(function(root, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(7), __webpack_require__(19)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(7), __webpack_require__(20), __webpack_require__(24), __webpack_require__(21)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(1);
	var socketApi = __webpack_require__(16);

	module.exports = Backbone.Model.extend(socketApi, {
	  defaults: {
	    drawer: true
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Marionette = __webpack_require__(1).Marionette;
	var DrawingView = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(1);
	var DrawingBase = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  emitSocket: function emitSocket(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DrawingBaseView = __webpack_require__(18);

	module.exports = DrawingBaseView.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone = __webpack_require__(1);
	var drawer = __webpack_require__(25);
	...
	var translateEvent = function translateEvent(e) {
	...
	module.exports = Backbone.View.extend({
	  ...
	  triggerClear: function triggerClear() {
	    this.model.emitSocket({ modelEvent: 'drawing:clear' });
	  },

	  drawCoordinates: function drawCoordinates(data) {
	    drawer[data.eventType](this.calculateCoordinatesWithScale(data), this.canvasContext);
	  },

	  calculateCoordinatesWithScale: function calculateCoordinatesWithScale(data) {
	  ...
	  attachCanvasListeners: function attachCanvasListeners() {
	  ...
	  resize: function resize(windowDimensions) {
	    if (this.$canvas) {
	      var point;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(7), __webpack_require__(20)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
	      return factory(Backbone, _);
	    }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	  } else if (typeof exports !== 'undefined') {
	    var Backbone = require('backbone');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__p += '<h1>Welcome to: ' +
	__e( roomName ) +
	'</h1>\n\n<canvas id="display" width="1120" height="630"></canvas>\n\n';
...
/***/ function(module, exports, __webpack_require__) {
	...
	__p += '<h3>Drawing for: ' +
	__e( roomName ) +
	'</h3>\n\n<canvas id="drawer" width="960" height="540"></canvas>\n\n<button type="button" class="clear-canvas">Start Over</button>\n\n';
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  dragstart: function dragstart(data, context) {
	  ...
	  drag: function drag(data, context) {
	    if (paint) {
	  ...
	  dragend: function dragend(data, context) {
	    context.stroke();
	    context.closePath();
	    paint = false;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var object = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(38);
	var debug = __webpack_require__(57)('engine.io-client:socket');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(57)('engine.io-client:polling-xhr');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseqs = __webpack_require__(56);
	var inherit = __webpack_require__(72);
	var debug = __webpack_require__(57)('engine.io-client:websocket');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parser = __webpack_require__(51);
	var inherit = __webpack_require__(72);
	var debug = __webpack_require__(57)('engine.io-client:polling');
